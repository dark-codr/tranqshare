...
try:
    ...
    ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["tranqshare.com", "www.tranqshare.com"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Tranquil Share <noreply@tranqshare.com>",
)
...
EMAIL_PORT = env("EMAIL_HOST_PORT", default="464")
EMAIL_USE_SSL = True
# EMAIL_USE_TLS = True
